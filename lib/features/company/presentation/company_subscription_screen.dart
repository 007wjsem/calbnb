          ...
          return ListView(
            ...
            children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildUsageBar(
                        ...
                        used: 1, // Placeholder until users count map is integrated natively
                        max: tier.maxUsers,
                      ),
                      const SizedBox(height: 32),
                      const Divider(),
              ...
              _buildPlanOption(
                ...
                isCurrent: tier == SubscriptionTier.free,
              ),
              const SizedBox(height: 12),
              _buildPlanOption(
                title: 'Bronze',
                ...
                isCurrent: tier == SubscriptionTier.bronze,
              ),
              const SizedBox(height: 12),
              _buildPlanOption(
                title: 'Silver',
                ...
                isCurrent: tier == SubscriptionTier.silver,
              ),
              const SizedBox(height: 12),
              _buildPlanOption(
                title: 'Gold',
                ...
                isCurrent: tier == SubscriptionTier.gold,
                isRecommended: true,
              ),
              const SizedBox(height: 12),
              _buildPlanOption(
                ...
                isCurrent: tier == SubscriptionTier.platinum,
              ),
              const SizedBox(height: 12),
              _buildPlanOption(
                title: 'Diamond',
                ...
                isCurrent: tier == SubscriptionTier.diamond,
              ),
            ],
          );
        },
